...
class Api::Admin::AdminUsersControllerTest < ActionController::TestCase
  ...
  def test_unauthorized
    ...
    request.env["HTTP_AUTHORIZATION"] = "TheUltimateScienceFictionAwardWinningBooksInternetDatabase invalid-token-#{SecureRandom.uuid}"
    get :index
    assert_unauthorized
  end

  def test_index
    request.env["HTTP_AUTHORIZATION"] = "TheUltimateScienceFictionAwardWinningBooksInternetDatabase TEST_ADMIN_TOKEN_2"
